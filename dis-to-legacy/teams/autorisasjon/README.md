# autorisasjon — moving services out of the legacy cluster
...
`altinn-authentication/httproute.yaml`. Near the bottom there is a commented-out block —
...
`envs/<env>/autorisasjon/kustomization.yaml`. That way you change one environment at
